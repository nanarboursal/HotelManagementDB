...
#                                   "Room_Number"))
    ...
    #                               "role",
    #                               "ssn"))
    # executer.make_view("Admin_View_Employee",
    #                     "EMPLOYEE",
    #                     select_col=("employee_ID",
    #                                 "first_name",
    #                                 "last_name",
    #                                 "address",
    #                                 "email",
    ...
    #                                 "role",
    #                                 "ssn"))
    # executer.make_view("Employee_View_Employee",
    #                     "EMPLOYEE",
    #                     select_col=("employee_ID",
    #                                 "first_name",
    #                                 "last_name",
    ...
    executer.make_view("Guest_View_Employee2",
                        "EMPLOYEE",
                        select_col=("employee_ID",
                                    "first_name",
                                    "last_name",
                                    ...
                                    "cell_phone_number"))
        # -----------------------
    # executer.make_view("Admin_View_Reservation",
    #                     "RESERVATION",
    #                     select_col=("Reservation_ID",
    #                                 "No_Rooms",
    #                                 "Guest_ID",
    #                                 "Credit_Card_ID",
    #                                 "No_Guests",
    ...
    # executer.make_view("Employee_View_Reservation",
    #                     "RESERVATION",
    #                     select_col=("Reservation_ID",
    #                                 "No_Rooms",
    #                                 "Guest_ID",
    ...
    # executer.make_view("Guest_View_Reservation",
    #                     "RESERVATION",
    #                     select_col=("Reservation_ID",
    #                                 "No_Rooms",
    #                                 "Guest_ID",
    ...
    #                                 "No_Nights"))
    #     # ----------------
    # executer.make_view("Admin_View_Credit",
    #                     "CREDIT_CARD",
    #                     select_col=("Credit_Card_ID",
    #                                 "Card_Number",
    #                                 "Card_Name",
    #                                 "Card_Type",
    #                                 "Expiration_Date"))

    # executer.make_view("Employee_View_Credit",
    #                     "CREDIT_CARD",
    #                     select_col=("Credit_Card_ID",
    #                                 "Card_Name",
    #                                 "Card_Type",
    ...
    # executer.make_view("Guest_View_Credit",
    #                     "CREDIT_CARD",
    #                     select_col=("Credit_Card_ID",
    #                                 "Card_Number",
    #                                 "Card_Name",
